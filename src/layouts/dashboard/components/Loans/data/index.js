...
export default function data() {
  ...
  return {
    columns: [
      { name: "type", align: "left", label: "Type" },
      { name: "duration", align: "left", label: "Duration" },
      { name: "amountBorrowed", align: "center", label: "Borrowed" },
      { name: "interestAmount", align: "center", label: "Interest" },
      { name: "totalAmountDue", align: "center", label: "Amount Due" },
      { name: "dueDate", align: "center", label: "Due date" },
