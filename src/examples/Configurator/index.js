...
function Configurator() {
  ...
  const sidenavColors = ["primary", "dark", "error", "success", "warning", "error"];
  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
      <SoftBox
        ...
        px={3}
      >
        <SoftBox display="flex" flexDirection="row" justifyContent="start" alignItems="center">
          <Avatar src={profileData?.photoUrl} />
          <SoftBox p={1}>
            <SoftTypography variant="h6">
              {`${profileData?.firstName}, ${profileData?.lastName}`.toUpperCase()}
            </SoftTypography>
      ...
      <SoftBox pt={1.25} pb={3} px={3}></SoftBox>
